...
function Get-TeremoqGitCheckoutContext {
    ...
    foreach ($required in @('client/Install-LanClient.ps1', 'client/Initialize-LanClientState.ps1', 'client/Update-LanClient.ps1', 'client/Stage-LanClientUpdate.ps1', 'client/Pin-LanUpdateLauncher.ps1', 'client/Pin-LanTaskSources.ps1', 'client/Invoke-LanLoad.ps1', 'client/Verify-Package.ps1', 'client/Import-BrowserObservation.ps1', 'client/Client-Distribution.ps1', 'client/Client-Slot-State.ps1', 'client/Manage-LanClientSlots.ps1', 'windows/Preflight-Client.ps1', 'windows/Collect-Evidence.ps1', 'windows/Preflight-Contract.ps1')) {
