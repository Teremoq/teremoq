...
La campaña de cierre de PoC sigue el
[contrato de aceptación y delegación](poc/ACCEPTANCE-AND-DELEGATION.md).
TP-PLATFORM-CHAOS conduce las pruebas con uso exclusivo del laboratorio;
el Master registra el traspaso y conserva la aceptación. Los especialistas
mantienen la propiedad de las correcciones. Este acuerdo reutiliza los perfiles
y tareas existentes e incluye obligatoriamente la resiliencia del canal.
